...
# exmaple:   bash build_all_the_things.sh v0.14.1 digibyte-core/digibyte
# this will build:
...
get_latest_tag () {
  local url="curl ${masterApiEndpoint}/repos/digibyte-core/digibyte/tags"
...
for platform in "${platforms[@]}"; do
  ...
  "${branch_or_tag}" \
  "${repo}" \
  "../digibyte/contrib/gitian-descriptors/gitian-${platform}.yml"
done
